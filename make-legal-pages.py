...
<div class="box acc">
  ...
  it. If you want it, it is $500 and it goes live on your own domain. If you do not want it, you owe
  nothing, you are not chased, and that is the end of it. You own the site and the domain either
  way once it is paid for.</p>
</div>
...
<ul>
  ...
  <li>Your domain name, registered <strong>in your name</strong>, and the hosting set up.</li>
...
design, and the domain name. The domain is registered in your name from the start, and you get the
login. We do not hold your domain, and we will never hold a finished site hostage over an
invoice — the worst that happens is it does not go live.</p>
...
pages = [
    ("privacy.html", shell(
        ...
        "us, and we delete it the moment you ask.",
        privacy_body)),
    ("terms.html", shell(
        "terms.html",
        "Terms — Akkad Studio",
